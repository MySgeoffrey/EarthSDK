 ...
 */
#ifndef OSGEARTHUTIL_EARTHMANIPULATOREX
#define OSGEARTHUTIL_EARTHMANIPULATOREX
...
namespace osgEarth { namespace Util
{
     ...
     */
    class VR_GLOBEWIDGET_DLL VREarthManipulator : public osgGA::CameraManipulator
    {
    public:
    ...
    public:
        ...
        public:
             ...
             *
             * @param action
             *      The VREarthManipulator::ActionType value to which to bind this mouse
             *      input specification.
             *
             * @param button_mask
             ...
             *
             * @param action
             *      The VREarthManipulator::ActionType value to which to bind this mouse click
             *      input specification.
             *
             * @param button_mask
             *      Mask of osgGA::GUIEventAdapter::MouseButtonMask values
             ...
             *
             * @param action
             *      The VREarthManipulator::ActionType value to which to bind this double-click
             *      input specification.
             *
             * @param button_mask
             *      Mask of osgGA::GUIEventAdapter::MouseButtonMask values
             ...
             *
             * @param action
             *      The VREarthManipulator::ActionType value to which to bind this key
             *      input specification.
             *
             * @param key
             ...
             *
             * @param action
             *      The VREarthManipulator::ActionType value to which to bind this scroll
             *      input specification.
             *
        ...
        private:
            ...
            friend class VREarthManipulator;
    ...
    public:
        VREarthManipulator();
        VREarthManipulator(osg::ArgumentParser& args);
        VREarthManipulator(const VREarthManipulator& rhs);
    ...
    public: // osgGA::CameraManipulator
        ...
        virtual const char* className() const { return "VREarthManipulator"; }
