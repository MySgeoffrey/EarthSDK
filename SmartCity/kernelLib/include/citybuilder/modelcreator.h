...
class VR_CITYBUILDER_DLL CPipelineStyle
{
public:
	CPipelineStyle()
	{
...
class VR_CITYBUILDER_DLL PositionNormalColorTexture
{
public:
...
class VR_CITYBUILDER_DLL CPipelineData
{
public:
	CPipelineData()
	{
...
class VR_CITYBUILDER_DLL CModelCreator
{
public:
	CModelCreator(void);
