...
#ifndef OSGEARTH_DRAPEABLE_EX_NODE_H
#define OSGEARTH_DRAPEABLE_EX_NODE_H 1
...
namespace osgEarth
{
     ...
     */
    class DrapeableNodeEX : public osg::Group
    {
    public:
        META_Object(osgEarth, DrapeableNodeEX);
        ...
        /** Copy */
        DrapeableNodeEX(const DrapeableNodeEX& rhs, const osg::CopyOp& copy);
