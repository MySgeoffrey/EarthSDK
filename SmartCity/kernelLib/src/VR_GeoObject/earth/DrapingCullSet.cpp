...
DrapingCullSetEX&
DrapingCullSetEX::get(const osg::Camera* cam)
{    
    static PerObjectFastMap<const osg::Camera*, DrapingCullSetEX> sets;
...
DrapingCullSetEX::DrapingCullSetEX() :
_frameCulled( true )
{
    // nop
}
...
void
DrapingCullSetEX::push(DrapeableNodeEX* node, const osg::NodePath& path, const osg::FrameStamp* fs)
{
...
void
DrapingCullSetEX::accept(osg::NodeVisitor& nv)
{
