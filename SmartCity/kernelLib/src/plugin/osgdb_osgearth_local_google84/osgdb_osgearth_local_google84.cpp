...
namespace osgEarth {
	namespace Drivers
	{
		...
		*/
		class Local_google84Options : public TileSourceOptions // NO EXPORT; header only
		{
		public:
		...
		public:
			...
			*/
			Local_google84Options(const TileSourceOptions& opt = TileSourceOptions()) : TileSourceOptions(opt),
				_imagerySet("Aerial"),
				_imageryMetadataAPI("http://dev.virtualearth.net/REST/v1/Imagery/Metadata")
			{
				setDriver("local_google84");
				fromConfig(_conf);
			}

			/** dtor */
			virtual ~Local_google84Options() { }
...
{
private:
	osgEarth::Drivers::Local_google84Options _options;
...
public:
	...
	{
		supportsExtension("osgearth_local_google84", "Microsoft Bing Driver");
	}
