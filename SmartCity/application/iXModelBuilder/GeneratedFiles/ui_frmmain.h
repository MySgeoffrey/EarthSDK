...
public:
    ...
    void setupUi(QDialog *frmMain)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/image/main.ico"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        ...
        horizontalLayout_8 = new QHBoxLayout(layer_tab);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/image/png-0087.png"), QSize(), QIcon::Normal, QIcon::Off);
        searchPlaceName->setIcon(icon1);
        ...
        toolBox_3 = new QToolBox(service_tab_2);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/image/setting.png"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(service_tab_2, icon5, QString());
